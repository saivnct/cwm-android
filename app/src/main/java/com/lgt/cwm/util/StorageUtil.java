...
import com.lgt.cwm.CwmApplication;
import com.lgt.cwm.R;
import com.lgt.cwm.ui.components.permissions.Permissions;

public class StorageUtil {

    private static final String PRODUCTION_PACKAGE_ID = "com.lgt.cwm";
    ...
    public static File getBackupDirectory() throws NoExternalStorageException {
        File storage = Environment.getExternalStorageDirectory();
        File cwm  = new File(storage, "Cwm");
        File backups = new File(cwm, "Backups");
    ...
    private static File getAppStorageDir() throws NoExternalStorageException {
    ...
    public static boolean canWriteInAppStorageDir() {
        File storage;

        try {
            storage = getAppStorageDir();
    ...
    public static boolean canReadFromMediaStore(Context context) {
        return Permissions.hasAll(context, Manifest.permission.READ_EXTERNAL_STORAGE);
    }
