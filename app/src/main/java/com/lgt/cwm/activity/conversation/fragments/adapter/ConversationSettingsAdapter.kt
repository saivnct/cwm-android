...
import com.lgt.cwm.activity.conversation.fragments.models.*
...
import com.lgt.cwm.util.CommunicationActions
import com.lgt.cwm.util.DebugConfig
import com.lgt.cwm.util.ViewUtil
import com.lgt.cwm.util.visible
import javax.inject.Inject

class ConversationSettingsAdapter : MappingAdapter() {
    val TAG = ConversationSettingsAdapter::class.java.simpleName.toString()

    @Inject
    lateinit var debugConfig: DebugConfig

    init {
        registerFactory(ClickPreference::class.java, LayoutFactory(::ClickPreferenceViewHolder, R.layout.conversation_settings_preference_item))
        registerFactory(LongClickPreference::class.java, LayoutFactory(::LongClickPreferenceViewHolder, R.layout.conversation_settings_preference_item))
        registerFactory(TextPreference::class.java, LayoutFactory(::TextPreferenceViewHolder, R.layout.conversation_settings_preference_item))
        registerFactory(RadioListPreference::class.java, LayoutFactory(::RadioListPreferenceViewHolder, R.layout.conversation_settings_preference_item))
        registerFactory(MultiSelectListPreference::class.java, LayoutFactory(::MultiSelectListPreferenceViewHolder, R.layout.conversation_settings_preference_item))
        registerFactory(ExternalLinkPreference::class.java, LayoutFactory(::ExternalLinkPreferenceViewHolder, R.layout.conversation_settings_preference_item))
        registerFactory(DividerPreference::class.java, LayoutFactory(::DividerPreferenceViewHolder, R.layout.conversation_settings_divider_item))
        registerFactory(SectionHeaderPreference::class.java, LayoutFactory(::SectionHeaderPreferenceViewHolder, R.layout.conversation_settings_section_header))
        registerFactory(SwitchPreference::class.java, LayoutFactory(::SwitchPreferenceViewHolder, R.layout.conversation_settings_switch_preference_item))
        registerFactory(RadioPreference::class.java, LayoutFactory(::RadioPreferenceViewHolder, R.layout.conversation_settings_radio_preference_item))
        Text.register(this)
        Space.register(this)
...
class RadioListPreferenceViewHolder(itemView: View) : PreferenceViewHolder<RadioListPreference>(itemView) {
    ...
    companion object {
        private val TAG = RadioListPreferenceViewHolder::class.simpleName.toString()
    }
}
...
class ExternalLinkPreferenceViewHolder(itemView: View) : PreferenceViewHolder<ExternalLinkPreference>(itemView) {
    override fun bind(model: ExternalLinkPreference) {
        ...
        val externalLinkIcon = requireNotNull(ContextCompat.getDrawable(context, R.drawable.ic_open_in_new_24))
