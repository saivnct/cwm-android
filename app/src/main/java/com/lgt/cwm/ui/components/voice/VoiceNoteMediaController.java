...
import com.lgt.cwm.util.DefaultValueLiveData;
...
public class VoiceNoteMediaController implements DefaultLifecycleObserver {
    ...
    private static final String TAG = VoiceNoteMediaController.class.getSimpleName();
...
//                                playbackState.getSpeed())));
                LiveData<String> name = new MutableLiveData<String>("Playing audio");
    ...
    {
//        Log.d("AAA", "extractStateFromMetadata " + mediaMetadataCompat.getDescription());
//        Log.d("AAA", "extractStateFromMetadata " + mediaMetadataCompat.getDescription().getMediaUri());
...
//                canExtractPlaybackInformationFromMetadata(mediaMetadataCompat))
    ...
    private static @NonNull VoiceNotePlaybackState.ClipType getClipType(@Nullable Bundle mediaExtras) {
        return new VoiceNotePlaybackState.ClipType.Message(0,
                    "",
                    "",
                    0,
                    0,
