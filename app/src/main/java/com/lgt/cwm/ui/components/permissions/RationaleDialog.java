package com.lgt.cwm.ui.components.permissions;
...
import com.lgt.cwm.util.ThemeUtil;
...
public class RationaleDialog {
    ...
    public static MaterialAlertDialogBuilder createFor(@NonNull Context context, @NonNull String message, @DrawableRes int... drawables) {
        ...
        return new MaterialAlertDialogBuilder(context,
                ThemeUtil.isDarkTheme(context) ? R.style.Theme_Cwm_AlertDialog_Dark_Cornered
                        : R.style.Theme_Cwm_AlertDialog_Light_Cornered)
                .setView(view);
    }
