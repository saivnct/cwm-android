...
import com.lgt.cwm.util.SpanUtil

sealed class ConversationSettingsText {
    ...
    companion object {
        fun from(@StringRes stringId: Int, @ColorInt textColor: Int): ConversationSettingsText =
            FromResource(stringId, listOf(ColorModifier(textColor)))

        fun from(@StringRes stringId: Int, vararg modifiers: Modifier): ConversationSettingsText =
            FromResource(stringId, modifiers.toList())

        fun from(charSequence: CharSequence, vararg modifiers: Modifier): ConversationSettingsText =
