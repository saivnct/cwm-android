...
class LetterHeaderDecoration(private val context: Context, private val hideDecoration: () -> Boolean) : RecyclerView.ItemDecoration() {
    ...
    private val padStart = context.resources.getDimensionPixelSize(R.dimen.grid_2)
    ...
    private val textPaint = Paint().apply {
        ...
        textSize = ViewUtil.spToPx(20f).toFloat()
    }
    ...
    override fun getItemOffsets(outRect: Rect, view: View, parent: RecyclerView, state: RecyclerView.State) {
        ...
        if (dividerHeight == -1) {
//            val v = LayoutInflater.from(context).inflate(R.layout.contact_section_header, parent, false)
//            v.measure(0, 0)
//            dividerHeight = v.measuredHeight
            dividerHeight = ViewUtil.dpToPx(32)
        }
