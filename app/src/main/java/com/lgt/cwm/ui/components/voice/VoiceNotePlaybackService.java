...
public class VoiceNotePlaybackService extends MediaBrowserServiceCompat {
    ...
    public static final String ACTION_NEXT_PLAYBACK_SPEED = "VoiceNotePlaybackService.action.next_playback_speed";
    public static final String ACTION_SET_AUDIO_STREAM    = "VoiceNotePlaybackService.action.set_audio_stream";

    public  static final String CLEAR_KEY_EVENT          = BuildConfig.APPLICATION_ID + ".service.action.CLEAR_KEY_EVENT";

    private static final String TAG                 = VoiceNotePlaybackService.class.getSimpleName();
...
//            });
    ...
    private static class KeyClearedReceiver extends BroadcastReceiver {
        private static final IntentFilter KEY_CLEARED_FILTER = new IntentFilter(CLEAR_KEY_EVENT);
