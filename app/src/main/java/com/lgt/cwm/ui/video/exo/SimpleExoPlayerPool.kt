package com.lgt.cwm.ui.video.exo
...
import com.lgt.cwm.util.AppForegroundObserver
...
//        ApplicationDependencies.getAppForegroundObserver().addListener(this)
    ...
    override fun getMaxSimultaneousPlayback(): Int {
        ...
        return MAXIMUM_SUPPORTED_PLAYBACK_PRE_23
...
abstract class ExoPlayerPool<T : ExoPlayer>(
    ...
    companion object {
        private val TAG = ExoPlayerPool::class.java.simpleName.toString()
    }
