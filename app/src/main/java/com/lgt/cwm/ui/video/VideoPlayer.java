...
public class VideoPlayer extends FrameLayout {
    ...
    private static final String TAG = VideoPlayer.class.getSimpleName().toString();
    ...
    public void setVideoSource(@NonNull Uri videoUri, boolean autoplay, Context context) {
        if (exoPlayer == null) {
